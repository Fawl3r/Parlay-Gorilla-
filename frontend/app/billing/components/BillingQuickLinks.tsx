...
export function BillingQuickLinks({ onOpenPortal }: BillingQuickLinksProps) {
  ...
  return (
    ...
    >
      <Link
        href="/usage"
        className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-gray-200 hover:text-white hover:bg-white/10 transition-colors"
      >
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-gray-200 hover:text-white hover:bg-white/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {loadingPortal ? (
          <>
