...
async function fetchAnalysis(slug: string, forceRefresh = false): Promise<GameAnalysisResponse> {
  ...
  if (!forceRefresh && needsProbabilityRefresh(analysis)) {
    ...
    return fetchAnalysis(slug, true)
  }
...
export default async function AnalysisPage({ params }: Props) {
  try {
    ...
    const structuredData = {
      ...
      "@type": "Article",
      headline: analysis.seo_metadata?.title || `${analysis.matchup} Prediction & Picks`,
