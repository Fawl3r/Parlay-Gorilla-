      ...
      <div className="container mx-auto px-4">
        <motion.div {...SECTION_ANIM} className="mb-10 md:mb-12">
          ...
          <p className="mt-3 text-gray-400 max-w-3xl leading-relaxed">
            ...
            permanent, time-stamped proof that this parlay existed before the game. This creates a tamper-proof record
          ...
          <p className="mt-3 text-gray-400 max-w-3xl leading-relaxed">
            ...
            store emails, names, or personal details. The verification record contains only a non-identifying{" "}
            <span className="text-white/85 font-semibold">account number</span> and your parlay's fingerprint.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <motion.div {...SECTION_ANIM} transition={{ delay: 0.11 }}>
            <NeonCard
              ...
              description="Our verification system uses industry-standard methods to create tamper-proof records."
              bullets={[
                "Efficient storage for proof payloads",
          ...
          <div className="rounded-3xl border border-white/10 bg-black/35 backdrop-blur-xl p-6 md:p-7">
            ...
            <ol className="mt-4 grid gap-3 text-sm text-gray-300 leading-relaxed">
              {[
                ...
                "Your parlay now has a permanent, time-stamped proof that it existed before the game.",
            ...
            <div className="mt-6 text-xs text-gray-400">
              Verification is completely optional and creates a tamper-proof record for your reference. 
              This proof doesn't place bets and doesn't store personal data—it's just a time-stamped receipt 
              that your parlay existed at that moment.
            </div>
          </div>
        </motion.div>
      </div>
