...
export const metadata: Metadata = {
  ...
  description:
    "Learn Parlay Gorilla in minutes: build your first Gorilla Parlay, understand Gorilla Parlays vs Gorilla Parlay Builder, credits and limits, verification, and what to do next.",
