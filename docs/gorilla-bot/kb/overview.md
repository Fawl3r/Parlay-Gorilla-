...
What Gorilla Bot cannot do:
- It cannot place bets or change your account settings.
- It does not provide betting advice or guarantees.
- It does not access or share private information like passwords or payment details.

You can open Gorilla Bot from the floating chat button inside the app dashboard.
