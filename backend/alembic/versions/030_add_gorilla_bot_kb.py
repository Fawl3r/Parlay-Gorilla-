...
def upgrade() -> None:
    ...
    if "gorilla_bot_conversations" not in existing_tables:
        op.create_table(
    ...
    if "gorilla_bot_messages" not in existing_tables:
        op.create_table(
    ...
    if "gorilla_bot_kb_documents" not in existing_tables:
        op.create_table(
    ...
    if "gorilla_bot_kb_chunks" not in existing_tables:
        op.create_table(
